...
1/22/2025	1.0.0.1		SNA, Skyline	Initial version
****************************************************************************
*/
...
namespace ProvisionSpectrumElements_1
{
	...
	public class Script
	{
		...
		private static void RunSafe(Engine engine)
		{
			...
			ElementCreationDialog elementCreationDialog = new ElementCreationDialog(engine);
			controller.Run(elementCreationDialog);
		}
	}
}
